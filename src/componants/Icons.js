export const InstagramIcon = ({ className, ...rest }) => (
  ...
  >
    <path
      fill="currentColor"
      d="M224.1 141c-63.6 0-114.9 51.3-114.9 114.9S160.5 370.9 224.1 370.9 339 319.6 339 255.9 287.7 141 224.1 141zm0 186.5c-39.6 0-71.6-32.1-71.6-71.6s32.1-71.6 71.6-71.6 71.6 32.1 71.6 71.6-32.1 71.6-71.6 71.6zm146.4-194.3c0 14.9-12.1 27-27 27s-27-12.1-27-27 12.1-27 27-27 27 12.1 27 27zm76.1 27.2c-.2-54.6-14.8-103-58-146.2S382.1 0 327.5 0H120.5C65.9 0 17.5 14.8-25.7 58S-2 170.3-.1 225v202.5c0 54.6 14.8 103 58 146.2S65.9 512 120.5 512h207c54.6 0 103-14.8 146.2-58s58-91.6 58-146.2V225c-.1-54.6-14.8-103-58-146.2zM398.8 377.5c0 44.7-36.3 81-81 81H130.1c-44.7 0-81-36.3-81-81V134.5c0-44.7 36.3-81 81-81h187.7c44.7 0 81 36.3 81 81v243z"
    />
  </svg>
);
...
//     <path 
//       fill="#fff"
//       d="M380.9 97.1C339-2.6 221.8-17 140.7 53 72.2 109.3 50.9 205.1 82 282.6L55 444l165.7-43.6c75.9 40.5 170.3 10.5 206.2-66.9 47.8-97.5-9-184.1-45.3-236.4zM232.3 415.7c-23.3 6.1-47.5 7.2-70.8 3.2l-8.9-1.7-98.6 25.9 26.3-96.4-2.9-9.3c-16.6-39.7-18.4-84.2-5.1-125.3 13.7-43.1 44.2-79.3 85.1-102.4 87.8-48.6 204.2 6.1 224.2 105.7 21.3 105.4-70.5 192.6-149.3 200.3zm101.2-138c-5.4-2.7-31.9-15.8-36.8-17.7-4.9-1.8-8.4-2.7-11.9 2.7-3.6 5.4-13.6 17.7-16.7 21.3-3.1 3.6-6.2 4-11.6 1.3-34.9-17.5-57.8-31.3-81-71.1-6.1-10.5 6.1-9.6 17.5-31.9 2-4.1 1-7.7-.5-10.5-1.3-2.7-11.9-28.6-16.4-39.3-4.3-10.4-8.6-9-11.9-9-3.1 0-6.7-.4-10.5-.4-3.6 0-9.3 1.3-14.2 6.8-4.9 5.4-19.2 18.7-19.2 45.4 0 26.6 19.6 52.3 22.3 55.9 2.7 3.6 38.5 59.3 93.3 83.2 13 5.6 23.2 8.8 31.1 11.3 13.1 4.1 25 3.5 34.4 2.1 10.5-1.6 31.9-13 36.4-25.6 4.5-12.7 4.5-23.6 3.1-25.6-1.3-2.1-5.1-3.6-10.5-6.1z"
//     />
//   </svg>
// );
